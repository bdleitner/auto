...
import static com.bdl.auto.impl.processor.TypeMetadata.simpleTypeParam;
import static com.google.common.truth.Truth.assertThat;

import com.google.testing.compile.CompilationRule;

import com.bdl.auto.impl.processor.ClassMetadata.Category;
...
public class InheritanceMetadataTest {
  ...
  public void testSimpleInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.auto.impl.processor.Simple");
  ...
  public void testParameterizedInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.auto.impl.processor.ExtendedParameterized");
    TypeMirror inherited = simpleElement.getInterfaces().get(0);
    InheritanceMetadata actual = InheritanceMetadata.fromType((DeclaredType) inherited);
    assertThat(actual).isEqualTo(InheritanceMetadata.builder()
  ...
  public void testExtendedParameterizedInheritance() {
    TypeElement simpleElement = elements.getTypeElement("com.bdl.auto.impl.processor.ExtendedExtendedParameterized");
    TypeMirror inherited = simpleElement.getInterfaces().get(0);
    InheritanceMetadata actual = InheritanceMetadata.fromType((DeclaredType) inherited);
    assertThat(actual).isEqualTo(InheritanceMetadata.builder()
