...
public class MethodMetadataTest {
  ...
  public void testSimpleMethod() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.processor.Simple", "add"));
    ...
    method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.processor.Simple", "repeat"));
    assertThat(method).isEqualTo(MethodMetadata.builder()
        .setVisibility(Visibility.PUBLIC)
        .setIsAbstract(true)
  ...
  public void testParameterizedMethod() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.processor.ComplexParameterized", "filter"));
  ...
  public void testTypeConversion() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.processor.ComplexParameterized", "extend"));
    MethodMetadata expected = MethodMetadata.builder()
        .setVisibility(Visibility.PUBLIC)
        .setIsAbstract(true)
