...
public class MethodMetadataTest {
  ...
  public void testSimpleMethod() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.Simple", "add"));
    ...
    method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.Simple", "repeat"));
    assertThat(method).isEqualTo(MethodMetadata.builder()
        .setVisibility(Visibility.PUBLIC)
        .setIsAbstract(true)
  ...
  public void testAnnotations() {
    TypeElement typeElement = elements.getTypeElement("com.bdl.auto.impl.HasOverrides");
    ExecutableElement method = null;
    for (Element element : typeElement.getEnclosedElements()) {
      if (element.getSimpleName().toString().equals("overriddenBooleanMethod")) {
    ...
    assertThat(actual).isEqualTo(MethodMetadata.builder()
        .setVisibility(Visibility.PUBLIC)
        .setIsAbstract(true)
        .setName("overriddenBooleanMethod")
        .setType(TypeMetadata.BOOLEAN)
        .addAnnotation(AnnotationMetadata.builder()
            .setType(TestingTypes.METHOD_IMPL)
            .putValue(
                MethodMetadata.builder()
                    .setVisibility(Visibility.PUBLIC)
                    .setIsAbstract(true)
                    .setType(TestingTypes.IMPL_OPTION)
                    .setName("value")
                    .build(),
                ValueMetadata.create(TestingTypes.IMPL_OPTION, "THROW_EXCEPTION"))
            .build())
        .build());
  }
  ...
  public void testParameterizedMethod() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.ComplexParameterized", "filter"));
  ...
  public void testTypeConversion() {
    MethodMetadata method = MethodMetadata.fromMethod(
        (ExecutableElement) getMethodElement("com.bdl.auto.impl.ComplexParameterized", "extend"));
    MethodMetadata expected = MethodMetadata.builder()
        .setVisibility(Visibility.PUBLIC)
        .setIsAbstract(true)
